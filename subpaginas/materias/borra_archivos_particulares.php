...
<body>
    ...
    <?php
        echo "<p><b>Se procede a guardar las modificaciones realizadas. Número de registros: $numero_total_archivos</b></p>";
        ...
        for ($i = 1; $i <= $numero_total_archivos; $i++) {
            ...
            if ($campo_modificado==2){
                ...
                $result=mysqli_query($conexion, "delete from enlaces_profesores where cd_enlace='$cd_enlace' and departamento=$cd_departamento");
                if ($result ==1){
